...
import { BottomNav as SharedBottomNav, HistoryItem, InfoRow, Modal, SlipRow, TagihanCard, Toast } from "./components/shared.jsx";
...
export default function App() {
  ...
  const BottomNav = () => <SharedBottomNav tab={tab} setTab={setTab} setView={setView} />;
...
/* function LegacySlipRow({ label, val, color }) {
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
...
/* function LegacyInfoRow({ label, val, bold, accent }) {
  return (
